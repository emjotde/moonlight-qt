...
#define SER_CONFIRMEXTERNALLAUNCH "confirmexternallaunch"
...
StreamingPreferences::StreamingPreferences(const StreamingPreferences& other, QObject* parent)
    : QObject(parent),
      ...
      confirmExternalLaunchRequests(other.confirmExternalLaunchRequests),
...
void StreamingPreferences::reload()
{
    ...
    confirmExternalLaunchRequests = settings.value(SER_CONFIRMEXTERNALLAUNCH, true).toBool();
...
void StreamingPreferences::save()
{
    ...
    settings.setValue(SER_CONFIRMEXTERNALLAUNCH, confirmExternalLaunchRequests);
}
