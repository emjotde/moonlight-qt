...
public:
    ...
    Q_PROPERTY(bool confirmExternalLaunchRequests MEMBER confirmExternalLaunchRequests
               NOTIFY confirmExternalLaunchRequestsChanged)
    ...
    bool keepAwake;
    bool confirmExternalLaunchRequests;
    int packetSize;
...
signals:
    ...
    void confirmExternalLaunchRequestsChanged();
